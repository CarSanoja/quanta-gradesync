...
TRANSCRIPTION_INSTRUCTION = (
    ...
    "spelling mistake, never fix wrong arithmetic (if the student wrote 84 * 3/4 = 61, "
    "write 61 digit for digit: a wrong number on the page is evidence, do not compute "
    "the right value), never translate into "
